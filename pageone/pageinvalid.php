...
<div class="container" style="margin-top: 100px;">
    ...
    <h1 style="font-family: 'Raleway', sans-serif;font-weight: bold;">Sorry!!</h1>
  </div>
    <div class="row justify-content-center">
        <div class="col-md-6 text-center">
        <div class="card bg-white p-4">
            <div class="card-body">
            <h3 style="font-weight: normal;font-size: 25px;font-family: 'Raleway', sans-serif;">This page is temporarily unavailable at the moment.</h3>
            <Button class="btn btn-success mt-2" onclick="window.close()"><i class="fas fa-arrow-left"></i> Back to site</Button>
            </div>
        </div>
        </div>
    </div>
